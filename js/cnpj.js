...
cnpjOriginal = prompt("Digite o cnpj sem pontos ou barras");
...
console.log("Os 4 primeiros digitos são " + cnpj4);
console.log("Os 8 primeiros digitos são " + cnpj8);
...
//----------------------------------- Segundo Calculo do Cnpj ----------------------//
resultado = 0;
cnpj5 = cnpj12.substring(0, 5);
cnpj8 = cnpj12.substring(5, 13);

console.log("Os 5 primeiros digitos são " + cnpj5);
console.log("Os 8 primeiros digitos são " + cnpj8);
